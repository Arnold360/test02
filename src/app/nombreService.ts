...
export class nombreService {
   /*nombre fecha y tiempo de highlights en segundos*/
    nombreEntrevistas:string[] = ["ENTREVISTA A ANTAURO HUMALA TASSO - BEST CALE TV 01/2023 t1800 t2400 t3000 t6000 "  , 
                                  "El cuestionado plan de ANTAURO HUMALA: BUKELIZAR el país y retirarnos de la corte IDH | #LR 12/2023 t1800 t2400 t3000 t6000",
                                  "ANTAURO HUMALA NO SE ARREPIENTE DE NADA Y PROMETE MEDIDAS RADICALES 08/2023 t1800 t2400 t3000 t6000",
                                  "ENTREVISTA EN LA MIRA GO TV CUSCO 13/11/2023 t1800 t2400 t3000 t6000",
                                  "DETRAS DE LA VERDAD - PIURA 10/10/2023 t1800 t2400 t3000 t6000",
                                  "Entrevistas / Invitado: Myr.EP (r) Antauro Humala Tasso | La Noticia Perú 18/07/23 t1800 t2400 t3000 t6000"];
    ...
    urlEntrevistasYts:string[] = ["HfCjXPMj5VA", "6TXE6qFPI7Y", "ta50OnS7UQo", "zOO7PIKJd5k", "QEffxGNTHRQ", "xoLQeGL8Enw"];
      ...
      nombreMitines:string[] = ["ANTAURO HUMALA MITIN DESDE URUBAMBA - CUSCO 09/2022 t1800 t2400 t3000 t6000",
                                'Antauro Humala mitin desde Juliaca "todos juntos forjaremos la segunda Republica" 09/2022 t1800 t2400 t3000 t6000' ];
  ...
  constructor() {
    for(let e = 0; this.declaraciones.length > e; e++) {
      for( let i = 0; this.tipoNombres[e].length > i; i++) {
         ...
         this.destacados[e].push( /((?<=t)\d+)\s((?<=t)\d+)\s((?<=t)\d+)\s((?<=t)\d+)/.exec(this.tipoNombres[e][i]).map(this.agregarDestacados) );
       }
      }
    }
